...
final class DashSideNav extends StatelessComponent {
  ...
  Component build(BuildContext _) => div(id: 'sidenav', [
    ...
    ul(classes: 'navbar-nav', const [
      _SideNavDivider(),
      _TopNavItem(href: '/overview', label: '概览'),
      _TopNavItem(href: '/community', label: '社区'),
      _TopNavItem(href: 'https://dartpad.cn', label: '尝试 Dart'),
      _TopNavItem(href: '/get-dart', label: '获取 Dart SDK'),
      _TopNavItem(href: '/docs', label: '文档'),
      _SideNavDivider(),
    ]),
    _SideNavLevel(
      entries: navEntries,
