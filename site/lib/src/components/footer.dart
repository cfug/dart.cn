        ...
        div(classes: 'footer-section footer-tray', [
          ...
          div(classes: 'footer-utility-links', [
            ul([
              ...
              li([
                a(
                  href: 'https://flutter.cn/about',
                  target: Target.blank,
                  attributes: {'title': '关于中文文档'},
                  [text('关于中文文档')],
                ),
              ]),
              // dart.cn
              li([
                a(
                  href: 'https://flutter.cn/disclaimer',
                  target: Target.blank,
                  attributes: {'title': '免责条款'},
                  [text('免责条款')],
                ),
              ]),
            ]),
            ...
            div(classes: 'footer-technology', [
              a(
                ...
                attributes: {
                  'rel': 'noopener',
                  'title': '本网站采用 Jaspr (Dart) Web 框架构建。',
                },
                [text('本网站由 Jaspr 构建')],
              ),
            ]),
