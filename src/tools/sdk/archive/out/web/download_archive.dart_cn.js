...
C.ab=H.n(s(["macOS","Linux","Windows","ia32","x64","ARMv7","ARMv8 (ARM64)","Dart SDK"]),t.s)
C.l=new H.an(8,{macOS:"macos",Linux:"linux",Windows:"windows",ia32:"ia32",x64:"x64",ARMv7:"arm","ARMv8 (ARM64)":"arm64","Dart SDK":"dartsdk"},C.ab,t.w)
C.ai=H.n(s(["macOS","Linux","Windows"]),t.s)
C.q=H.n(s(["Dart SDK"]),t.s)
C.aq=new M.bb("x64",C.q)
C.K=new M.bb("ia32",C.q)
C.F=H.n(s([C.aq,C.K]),t.r)
C.ap=new M.bb("x64",C.x)
C.ar=new M.bb("ARMv8 (ARM64)",C.q)
C.as=new M.bb("ARMv7",C.q)
C.ac=H.n(s([C.ap,C.K,C.ar,C.as]),t.r)
C.I=new H.an(3,{macOS:C.F,Linux:C.ac,Windows:C.F},C.ai,H.aE("an<b,f<bb>>"))
