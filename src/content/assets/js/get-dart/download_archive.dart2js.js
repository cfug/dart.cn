...
q=p}while(true)switch(q){case 0:n=B.t7.gvc(),n=n.gkz(n),m=r.a,l=m.f,k=r.e,j=s.a,i="https://storage.flutter-io.cn/dart-archive/channels/"+j+"/release/",h=t.E,g=r.c,f=g==="stable",e=g==="beta",g=g==="dev",j=j==="dev",d=r.b,c=d.a,d=d.b
case 2:if(!n.G()){q=3
break}b=n.gl()
a0=B.t7.q(0,b)
if(a0==null)a0=B.xD
